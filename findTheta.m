...
searchRegion = last_closestIdx-10:last_closestIdx+89;
...
%for i = last_closestIdx-5:last_closestIdx+20
    ...
    %k = k+1;
%end
searchRegion(find(searchRegion < 1)) = 1;
searchRegion(find(searchRegion > N_Track)) = N_Track;
...
if sqrt(e) > (trackWidth(minIndex)*1.25)/2
