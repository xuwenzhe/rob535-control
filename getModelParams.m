...
elseif ModelNo==2
    ...
    ModelParams.Scale=1.0;%scale of the car (1 is a 1:43 scale car)
    ...
    ModelParams.stateindex_x=1; %x position
    ModelParams.stateindex_y=3; %y position
    ModelParams.stateindex_phi=5; %orientation
    ModelParams.stateindex_vx=2; %longitudinal velocity
    ModelParams.stateindex_vy=4; %lateral velocity
    ModelParams.stateindex_omega=6; %yaw rate
    ModelParams.stateindex_theta=7; %virtual position

    ModelParams.inputindex_Fx=2; % Fx force
    ModelParams.inputindex_delta=1; %steering angle
    ModelParams.inputindex_vtheta=3; %virtual speed
